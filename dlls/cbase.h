...
public:
	...
	void		FireBullets2( ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iPenetration, int iTracerFreq, int iDamage, entvars_t *pevAttacker = NULL );

	Vector		FireBullets3( Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iPenetration, int iBulletType, int iDamage, float flRangeModifier, entvars_t *pevAttacker, bool bPistol );
