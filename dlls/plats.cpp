...
public:
    ...
    Vector		m_vRestartPosition;
    entvars_t* m_pevSavedTarget;
...
void CFuncTrain::Spawn(void)
{
    ...
    m_pevSavedTarget = m_pevCurrentTarget;
    m_vRestartPosition = pev->origin;
...
void CFuncTrain::Restart(void)
{
    ...
    m_pevCurrentTarget = m_pevSavedTarget;
    UTIL_SetOrigin(pev, m_vRestartPosition);
...
void CFuncTrackTrain::Next(void)
{
    ...
    ALERT(at_console, "Train speed = %f\n", pev->speed);
