...
class CItemKevlar : public CItem
{
    ...
    BOOL MyTouch(CBasePlayer* pPlayer)
    {
        ...
        MESSAGE_BEGIN(MSG_ONE, gmsgArmorType, NULL, pPlayer->edict());
        WRITE_BYTE(0);
        MESSAGE_END();
...
class CItemAssaultSuit : public CItem
{
    ...
    BOOL MyTouch(CBasePlayer* pPlayer)
    {
        ...
        EMIT_SOUND(pPlayer->edict(), CHAN_VOICE, "items/kevlar.wav", 1, ATTN_NORM);
...
class CItemThighPack : public CItem
{
    ...
    BOOL MyTouch(CBasePlayer* pPlayer)
    {
        if (pPlayer->m_iTeam != TEAM_CT || pPlayer->m_bHasDefuser)
            return FALSE;
