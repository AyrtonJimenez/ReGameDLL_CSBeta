...
{
    const char* pszAmmo1 = CBasePlayerItem::ItemInfoArray[pItem->m_iId].pszAmmo1;

    return pszAmmo1
        && CanHaveAmmo(pPlayer, pszAmmo1, CBasePlayerItem::ItemInfoArray[pItem->m_iId].iMaxAmmo1)
        || !pPlayer->HasPlayerItem(pItem);
}
